###########################################################################
## Makefile generated for Simulink model 'amanda'. 
## 
## Makefile     : amanda.mk
## Generated on : Mon Feb 08 09:07:50 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/amanda.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/Amanda/DOCUME~1/DOCUME~1/LTH/Exjobb/MATLAB~1/TESTME~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = amanda_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/amanda.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/amanda_ert_rtw -I$(START_DIR) -IC:/Users/Amanda/Documents/Documents/LTH/Exjobb/Hexapod/Camera/camera_rgbd -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/MATLAB/SupportPackages/R2015a/beaglebone/toolbox/target/supportpackages/beaglebone/@slCustomizer/../include -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=amanda -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=amanda -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/amanda_ert_rtw/ert_main.c $(START_DIR)/amanda_ert_rtw/amanda.c wrapper.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c
...
OBJS = amanda.c.o wrapper.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/amanda_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/amanda_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/amanda_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
