###########################################################################
## Makefile generated for Simulink model 'amanda_blinkingblink'. 
## 
## Makefile     : amanda_blinkingblink.mk
## Generated on : Wed Feb 17 11:09:21 2016
## MATLAB Coder version: 2.8 (R2015a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/amanda_blinkingblink.elf
...
PRODUCT_NAME              = amanda_blinkingblink
MAKEFILE                  = amanda_blinkingblink.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = amanda_blinkingblink_ref.rsp
...
CFLAGS =  -c -O0 -std=gnu99 -DEMPL_TARGET_LINUX -DMPU9150 -DAK8975_SECONDARY
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/amanda_blinkingblink.elf
...
INCLUDES_BUILDINFO = -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -I$(START_DIR)/amanda_blinkingblink_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/blocks/mex/../sfcn/include -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/blocks/mex/../sfcn/src -IC:/MATLAB/SupportPackages/R2015a/beaglebone/toolbox/target/supportpackages/beaglebone/@slCustomizer/../include -IC:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=amanda_blinkingblink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
DEFINES_BUILD_ARGS = -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0
DEFINES_IMPLIED = -DTID01EQ=0
DEFINES_OPTS = -DON_TARGET_WAIT_FOR_START=1
DEFINES_SKIPFORSIL = -DARM_PROJECT -DRT -DSTACK_SIZE=64
DEFINES_STANDARD = -DMODEL=amanda_blinkingblink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/amanda_blinkingblink_ert_rtw/ert_main.c $(START_DIR)/amanda_blinkingblink_ert_rtw/amanda_blinkingblink.c $(START_DIR)/amanda_blinkingblink_ert_rtw/amanda_blinkingblink_data.c $(START_DIR)/amanda_blinkingblink_ert_rtw/rtGetInf.c $(START_DIR)/amanda_blinkingblink_ert_rtw/rtGetNaN.c $(START_DIR)/amanda_blinkingblink_ert_rtw/rt_nonfinite.c rt_logging.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c C:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/src/MW_analogInput.c C:/MATLAB/SupportPackages/R2015a/armcortexa/toolbox/target/supportpackages/arm_cortex_a/src/MW_led.c
...
OBJS = amanda_blinkingblink.c.o amanda_blinkingblink_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o rt_logging.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o MW_analogInput.c.o MW_led.c.o
...
%.pp.o : $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/amanda_blinkingblink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/amanda_blinkingblink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/amanda_blinkingblink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
