function matrix = boxes_translation1
it = 1400;
interval = 5;
fileID = fopen('trajectorys\TA_Rdiff.txt','w');
...
[x,y,z] = getLocalCoordinates(D, interval);
B = [x;y;z];
%C(1:3, 1:3) =  quat2RM([q1(n) q2(n) q3(n) q4(n)]);
...
TT = RBT(A,B);
t = R_diff*C(1:3,4) + TT;
C = [quat2RM([q1(n) q2(n) q3(n) q4(n)]) t; 0 0 0 1];
