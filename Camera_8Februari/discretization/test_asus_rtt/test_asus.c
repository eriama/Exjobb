...
void test_asus_initialize(void)
{
  ...
  /* External mode info */
  test_asus_M->Sizes.checksums[0] = (1389392011U);
  test_asus_M->Sizes.checksums[1] = (594873398U);
  test_asus_M->Sizes.checksums[2] = (3508238730U);
  test_asus_M->Sizes.checksums[3] = (2628843505U);
