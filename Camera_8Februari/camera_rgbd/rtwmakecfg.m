...
%   MATLAB file generated on : 12-Feb-2016 12:04:24
...
% Dependency info for S-function 'asus_capture_sfcn'
info(1).SFunctionName = 'asus_capture_sfcn';
info(1).IncPaths = {'.\include'};
info(1).SrcPaths = {'.\src'};
info(1).SourceFiles = {'wrapper.c'};
info(1).TargetLibFiles = {'libNI.so'};
info(1).Language = 'C';
