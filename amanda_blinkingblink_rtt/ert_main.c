...
void baseRateTask(void *arg)
{
  ...
  while ((rtmGetErrorStatus(amanda_blinkingblink_M) == (NULL)) &&
...
int main(int argc, char **argv)
{
  ...
  if (rtmGetErrorStatus(amanda_blinkingblink_M) != NULL) {
    printf("\n**%s**\n", rtmGetErrorStatus(amanda_blinkingblink_M));
  }
