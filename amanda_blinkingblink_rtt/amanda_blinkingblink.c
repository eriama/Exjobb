...
void amanda_blinkingblink_output(void)
{
  uint32_T tmp;
  boolean_T tmp_0;
...
void amanda_blinkingblink_update(void)
{
...
void amanda_blinkingblink_initialize(void)
{
  ...
  /* External mode info */
  amanda_blinkingblink_M->Sizes.checksums[0] = (2690303059U);
  amanda_blinkingblink_M->Sizes.checksums[1] = (2623619520U);
  amanda_blinkingblink_M->Sizes.checksums[2] = (296454625U);
  amanda_blinkingblink_M->Sizes.checksums[3] = (4218828940U);
