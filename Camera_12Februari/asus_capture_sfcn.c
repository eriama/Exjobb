/*
 *   asus_capture_sfcn.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        asusCapture(uint16 y1[240][320])
 *
 *   Simulink version           : 8.5 (R2015a) 09-Feb-2015
 *   C source code generated on : 12-Feb-2016 14:31:28
 ...
 */
#define S_FUNCTION_NAME                asus_capture_sfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetOutputPortMatrixDimensions(S, 0, 240, 320);
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "asusInit", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "asusCapture", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for TerminateFcnSpec
     */
    ssRegMdlInfo(S, "asusTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
  }
