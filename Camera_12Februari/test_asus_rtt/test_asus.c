 ...
 * C/C++ source code generated on : Fri Feb 12 14:33:57 2016
 *
...
void test_asus_output(void)
{
  ...
  /* '<S2>:1:7' */
  for (b = 0; b < 76800; b++) {
    test_asus_B.D[b] = (real_T)test_asus_B.asus_capture_sfcn1[b] / 1000.0;
  }
...
void test_asus_initialize(void)
{
  ...
  rtmSetTFinal(test_asus_M, 10.0);
  test_asus_M->Timing.stepSize0 = 0.2;

  /* External mode info */
  test_asus_M->Sizes.checksums[0] = (3189231374U);
  test_asus_M->Sizes.checksums[1] = (1891692835U);
  test_asus_M->Sizes.checksums[2] = (1683203774U);
  test_asus_M->Sizes.checksums[3] = (2100869268U);
